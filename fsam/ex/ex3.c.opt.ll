...
entry:
  ...
  %0 = load i32** @r, align 8, !dbg !31
  %1 = load i32*** @p, align 8, !dbg !31
  store i32* %0, i32** %1, align 8, !dbg !31
  call void @llvm.dbg.declare(metadata !{i64* %t}, metadata !32), !dbg !36
  %call = call i32 @pthread_create(i64* %t, %union.pthread_attr_t* null, i8* (i8*)* @foo, i8* null) #4, !dbg !37
  %2 = load i64* %t, align 8, !dbg !38
  %call1 = call i32 @pthread_join(i64 %2, i8** null), !dbg !38
  %3 = load i32*** @p, align 8, !dbg !39
  %4 = load i32** %3, align 8, !dbg !39
  store i32* %4, i32** @c, align 8, !dbg !39
  ret i32 0, !dbg !40
}
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.5.0 (tags/RELEASE_350/final)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !14, metadata !2, metadata !"", i32 1} ; [ DW_TAG_compile_unit ] [/home/ysui/fig1tests/tt3.c] [DW_LANG_C99]
!1 = metadata !{metadata !"tt3.c", metadata !"/home/ysui/fig1tests"}
!2 = metadata !{}
!3 = metadata !{metadata !4, metadata !10}
!4 = metadata !{i32 786478, metadata !5, metadata !6, metadata !"foo", metadata !"foo", metadata !"", i32 8, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i8* (i8*)* @foo, null, null, metadata !2, i32 8} ; [ DW_TAG_subprogram ] [line 8] [def] [foo]
!5 = metadata !{metadata !"./tt3.c", metadata !"/home/ysui/fig1tests"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/ysui/fig1tests/./tt3.c]
...
!10 = metadata !{i32 786478, metadata !5, metadata !6, metadata !"main", metadata !"main", metadata !"", i32 13, metadata !11, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !2, i32 13} ; [ DW_TAG_subprogram ] [line 13] [def] [main]
...
!27 = metadata !{i32 786689, metadata !4, metadata !"ignored", metadata !6, i32 16777224, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [ignored] [line 8]
!28 = metadata !{i32 8, i32 17, metadata !4, null} ; [ DW_TAG_imported_declaration ]
!29 = metadata !{i32 9, i32 1, metadata !4, null}
!30 = metadata !{i32 10, i32 1, metadata !4, null}
!31 = metadata !{i32 14, i32 1, metadata !10, null}
!32 = metadata !{i32 786688, metadata !10, metadata !"t", metadata !6, i32 15, metadata !33, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [t] [line 15]
!33 = metadata !{i32 786454, metadata !34, null, metadata !"pthread_t", i32 60, i64 0, i64 0, i64 0, i32 0, metadata !35} ; [ DW_TAG_typedef ] [pthread_t] [line 60, size 0, align 0, offset 0] [from long unsigned int]
!34 = metadata !{metadata !"/usr/include/x86_64-linux-gnu/bits/pthreadtypes.h", metadata !"/home/ysui/fig1tests"}
...
!36 = metadata !{i32 15, i32 11, metadata !10, null}
!37 = metadata !{i32 16, i32 1, metadata !10, null}
!38 = metadata !{i32 17, i32 1, metadata !10, null}
!39 = metadata !{i32 18, i32 1, metadata !10, null}
!40 = metadata !{i32 19, i32 1, metadata !10, null}
