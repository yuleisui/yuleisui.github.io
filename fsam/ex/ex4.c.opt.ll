...
entry:
  ...
  %2 = load i32** @r, align 8, !dbg !30
  %3 = ptrtoint i32* %2 to i32, !dbg !30
  %4 = load i32** @x, align 8, !dbg !30
  store i32 %3, i32* %4, align 4, !dbg !30
  ret i8* null, !dbg !31
}
...
entry:
  ...
  %call = call i32 @pthread_create(i64* %t, %union.pthread_attr_t* null, i8* (i8*)* @foo, i8* null) #3, !dbg !37
  %0 = load i32*** @p, align 8, !dbg !38
  %1 = load i32** %0, align 8, !dbg !38
  store i32* %1, i32** @c, align 8, !dbg !38
  ret i32 0, !dbg !39
}
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.5.0 (tags/RELEASE_350/final)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !14, metadata !2, metadata !"", i32 1} ; [ DW_TAG_compile_unit ] [/home/ysui/fig1tests/tt4.c] [DW_LANG_C99]
!1 = metadata !{metadata !"tt4.c", metadata !"/home/ysui/fig1tests"}
!2 = metadata !{}
...
!5 = metadata !{metadata !"./tt4.c", metadata !"/home/ysui/fig1tests"}
!6 = metadata !{i32 786473, metadata !5}          ; [ DW_TAG_file_type ] [/home/ysui/fig1tests/./tt4.c]
...
!31 = metadata !{i32 11, i32 1, metadata !4, null}
